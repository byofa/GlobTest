...
La fonction foo() prend un tableau de tableaux contenant 2 chiffres, constituant une plage entre les 2. La fonction va ensuite rencontrer les plages et si elle se chevauche, elle renvoyera toutes les plages avec le plus petit chiffre et le plus grand, dans un autre tableau de tableaux.
### Question 2
...
### Réponse 3
J'ai pris environ une journée pour tout faire.
## Merci
